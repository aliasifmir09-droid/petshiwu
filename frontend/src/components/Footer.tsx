        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <h3 className="text-xl font-black bg-gradient-to-r from-white via-blue-200 to-white bg-clip-text text-transparent" style={{ fontFamily: "'Poppins', 'Inter', sans-serif" }}>
                petshiwu
              </h3>
            </div>
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <form className="flex gap-2">
                ...
                />
                <button className="bg-primary-600 px-4 py-2 rounded text-sm hover:bg-primary-700">
                  Subscribe
                </button>
              </form>
            </div>
