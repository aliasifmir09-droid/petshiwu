...
const dogFoodGenerator: PageGenerator = (n) => ({
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: `We carry all major dog food brands: Purina Pro Plan, Blue Buffalo, Hill's Science Diet, Royal Canin Merrick, Wellness, Iams, Pedigree, and many more. Over 10,000 dog products in total — dry, wet, grain-free, raw, and prescription formulas.`,
    },
    {
...
const catFoodGenerator: PageGenerator = (n) => ({
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: `Yes — we carry a wide range of grain-free cat food from brands like Blue Buffalo Wilderness, Wellness CORE, Merrick Grain-Free, and more. All delivered to ${n.name} with free shipping on orders over $49.`,
    },
  ],
...
const puppyFoodGenerator: PageGenerator = (n) => ({
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: `We carry every major puppy food brand: Hill's Science Diet Puppy, Purina Pro Plan Puppy, Royal Canin Puppy, Blue Buffalo Life Protection Puppy, Wellness Core Puppy, and Merrick Grain-Free Puppy. Formulas for small, medium, and large breeds.`,
    },
    {
...
const seniorDogFoodGenerator: PageGenerator = (n) => ({
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: `We carry every major senior dog brand: Hill's Science Diet Senior, Hill's Science Diet Perfect Weight 7+, Purina Pro Plan Senior 7+, Royal Canin Mature, Blue Buffalo Life Protection Senior, Wellness Complete Health Senior, and Merrick Grain-Free Senior.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Yes — we carry joint-support formulas from Purina Pro Plan, Hill's Science Diet, Royal Canin, and Wellness, all with added glucosamine, chondroitin, and omega-3s. Delivered to ${n.name} with free shipping on orders over $49.`,
    },
    {
...
const dryDogFoodGenerator: PageGenerator = (n) => ({
  ...
  solutionPoints: [
    ...
    `Purina ONE, Iams ProActive Health, Hill's Science Diet, Royal Canin, Blue Buffalo`,
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: `We carry every major dry dog food brand: Purina ONE SmartBlend, Purina Pro Plan, Iams ProActive Health, Hill's Science Diet, Royal Canin, Blue Buffalo Life Protection, Wellness Complete Health, Taste of the Wild, Merrick, and dozens more.`,
    },
    {
...
const grainFreeDogFoodGenerator: PageGenerator = (n) => ({
  ...
  solutionPoints: [
    ...
    `Taste of the Wild, Blue Buffalo Wilderness, Wellness CORE, Merrick`,
  ...
  faqItems: [
    {
      ...
      answer: `Yes — Petshiwu delivers grain-free dog food throughout ${n.name} and the surrounding ${n.borough} area including ${n.nearbyAreas}. We carry Taste of the Wild, Blue Buffalo Wilderness, Wellness CORE, Merrick Grain-Free, and more. Free delivery on orders over $49.`,
    },
    {
      question: `What grain-free dog food brands do you carry for ${n.name} delivery?`,
      answer: `We carry Taste of the Wild, Blue Buffalo Wilderness, Wellness CORE, Merrick Grain-Free, Nature's Variety Instinct, Canidae Pure, Diamond Naturals Grain-Free, and many more — including limited-ingredient diets.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Yes — we carry grain-free formulas with duck, lamb, rabbit, venison, salmon, bison, and wild boar from Nature's Variety. Delivered to ${n.name} with free shipping on orders over $49.`,
    },
  ],
  searchTerms: ['grain-free dog food', 'grain free dog food delivery', 'Taste of the Wild', 'Blue Buffalo Wilderness', 'limited ingredient dog food', 'DCM grain-free'],
});
...
const kittenFoodGenerator: PageGenerator = (n) => ({
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: `We carry Hill's Science Diet Kitten, Royal Canin Kitten, Purina Pro Plan Kitten, Blue Buffalo Wilderness Kitten, Wellness Core Kitten, Fancy Feast Kitten, and many more. Wet and dry formulas available.`,
    },
    {
...
const seniorCatFoodGenerator: PageGenerator = (n) => ({
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: `We carry Hill's Science Diet Senior 7+, Purina Pro Plan Senior, Royal Canin Indoor 7+, Royal Canin Mature, Blue Buffalo Life Protection Senior, Wellness Complete Health Senior, and more. Wet and dry formulas.`,
    },
    {
