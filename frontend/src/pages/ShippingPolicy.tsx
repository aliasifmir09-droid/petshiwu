      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            with same-day when you order by cutoff — including Queens Hillside. Next-day metro includes
            Hicksville, Hoboken, Jersey City, and select Westchester ZIPs. Same-day stays the five boroughs only.
          </p>
          <p className="mt-2">
