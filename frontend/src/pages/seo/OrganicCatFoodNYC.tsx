...
const OrganicCatFoodNYC = () => {
  return (
    <SEOLandingPage
      ...
      description="Organic and natural cat food delivered to all NYC boroughs. No artificial preservatives, no by-products, no fillers. Shop Wellness, Blue Buffalo, more. Free delivery over $49."
      ...
      solutionPoints={[
        ...
        "Blue Buffalo and Wellness — all available for NYC delivery",
      ...
      faqItems={[
        ...
        },
        {
          ...
          answer: "We carry Wellness Complete Health, Blue Buffalo True Solutions, and other premium natural cat food brands. These formulas use named animal proteins as first ingredients with no artificial additives."
        },
        {
