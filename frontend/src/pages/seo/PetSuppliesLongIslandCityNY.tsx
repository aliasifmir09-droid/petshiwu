  ...
  <SEOLandingPage
    ...
    faqItems={[
      ...
      },
      {
        ...
        answer: "We carry all top brands: Purina Pro Plan, Blue Buffalo, Royal Canin, Hill's Science Diet, Wellness, Merrick, and hundreds more. Over 10,000 products in total."
      },
      {
