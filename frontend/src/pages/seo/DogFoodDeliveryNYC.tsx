...
const DogFoodDeliveryNYC = () => {
  return (
    <SEOLandingPage
      ...
      solutionPoints={[
        "Every major dog food brand — Purina, Blue Buffalo, Royal Canin, Hill's, Wellness",
      ...
      faqItems={[
        {
          ...
          answer: "We stock all the top brands: Purina Pro Plan, Purina ONE, Blue Buffalo, Royal Canin, Hill's Science Diet, Wellness, Acana, Nutro, Pedigree, Iams, Nature's Recipe, and many more. Over 1,000 dog food products available."
        },
        {
          question: "Do you have grain-free dog food options?",
          answer: "Yes, we carry a wide range of grain-free dog foods from brands like Acana, Blue Buffalo Wilderness, Merrick Grain Free, and Wellness CORE. Filter by diet type on our site to find grain-free options quickly."
        },
        {
