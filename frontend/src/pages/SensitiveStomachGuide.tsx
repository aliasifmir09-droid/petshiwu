...
const SensitiveStomachGuide = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      {/* SEO COMPONENT - THIS IS CRITICAL */}
      <ArticleSEO 
        ...
        author="PetShiwu Nutrition Team"
        datePublished="2026-05-13"
        image="https://www.petshiwu.com/images/blog/sensitive-stomach-dog.jpg"
      ...
      <article className="prose lg:prose-xl mx-auto">
        ...
        <div className="border p-6 rounded-xl shadow-sm mb-6">
          ...
          <Link to="/products/hills-science-diet-sensitive" className="text-blue-600 font-bold hover:underline">
        ...
        <div className="border p-6 rounded-xl shadow-sm mb-6">
          ...
          <Link to="/products/purina-pro-plan-sensitive" className="text-blue-600 font-bold hover:underline">
        ...
        <div className="border p-6 rounded-xl shadow-sm mb-6">
          ...
          <Link to="/products/simply-nourish-limited-ingredient" className="text-blue-600 font-bold hover:underline">
        ...
        <div className="mt-12 p-8 bg-gray-100 rounded-2xl text-center">
          ...
          <Link to="/contact" className="bg-blue-900 text-white px-8 py-3 rounded-full font-bold hover:bg-blue-800 transition">
