/**
 * createBoroughHubs.ts
 * One-time script: inserts 5 rich borough hub blog posts into MongoDB.
 * Consolidates 44 thin neighborhood pages into 5 authoritative local SEO pages.
 * Run: ts-node src/scripts/createBoroughHubs.ts
 */
...
<p>Our catalog covers everything your pet needs:</p>
<ul>
...
<div itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    <h3 itemprop="name">Can I get same-day pet food delivery in Queens?</h3>
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">We process orders quickly and ship to Queens addresses as fast as possible. For urgent needs, check our current delivery estimates at checkout.</p>
    </div>
  </div>
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    ...
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">You can add delivery instructions at checkout — leave at door, ring buzzer, leave with neighbor, or any specific note for your building. Queens apartment buildings are our specialty.</p>
    </div>
  </div>
...
<ul>
  ...
  <li><strong>Canarsie &amp; East New York</strong></li>
...
<h2>What We Deliver</h2>
<p>Everything your pet needs, delivered to your Brooklyn address:</p>
<ul>
  ...
  <li><strong>Fish &amp; aquarium supplies</strong> — food, conditioners, filters, décor</li>
  <li><strong>Treats &amp; chews</strong> — training treats, dental chews, natural bones</li>
  <li><strong>Litter &amp; cleanup</strong> — clumping, crystal, natural litter and accessories</li>
  <li><strong>Health &amp; wellness</strong> — supplements, flea &amp; tick, vitamins, dental care</li>
</ul>
...
<div itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    ...
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">Absolutely. Add delivery instructions at checkout for your specific building — ring buzzer, leave at door, leave with super, or any custom note. We handle Brooklyn apartment deliveries all day.</p>
    </div>
  </div>

  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    <h3 itemprop="name">Do I need a membership?</h3>
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">No membership required. Shop without an account or create a free one for faster reordering. No subscriptions, no hidden fees.</p>
    </div>
  </div>
...
<ul>
  ...
  <li><strong>Yorkville &amp; Carnegie Hill</strong></li>
...
<ul>
  ...
  <li><strong>Treats &amp; chews</strong> — training treats, dental chews, natural bones</li>
  <li><strong>Litter &amp; cleanup</strong> — all litter types including lightweight options for apartment living</li>
  <li><strong>Health &amp; wellness</strong> — supplements, flea &amp; tick prevention, dental care</li>
</ul>
...
<ol>
  ...
  <li>Add to cart — no account required</li>
  <li>Shipping: <strong>$6 flat for orders under $49</strong>, <strong>FREE for orders $49 and over</strong></li>
  <li>Your order ships to your Manhattan address with apartment/unit delivery instructions</li>
</ol>
...
<div itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    ...
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">Yes. We deliver to Manhattan apartments, condos, co-ops, and townhouses. Add your building-specific instructions at checkout — doorman building, buzzer code, leave at door, or any custom note.</p>
    </div>
  </div>
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    <h3 itemprop="name">Can I get lightweight cat litter delivered to Manhattan?</h3>
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">Yes — we carry lightweight and compact litter options specifically suited for Manhattan apartment life where lugging heavy bags is impractical. Find them in our litter category at petshiwu.com.</p>
    </div>
  </div>
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    ...
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">Yes. You can specify doorman delivery at checkout. Your order will be left with the front desk if you're not home.</p>
    </div>
  </div>
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    ...
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">No minimum order. Order as little or as much as you need. Shipping is just $6 for orders under $49, and free above that threshold.</p>
    </div>
  </div>
...
<ul>
  ...
  <li><strong>Mott Haven &amp; Hunts Point &amp; Port Morris</strong></li>
...
<ul>
  <li><strong>Dog food</strong> — dry kibble, wet food, raw and freeze-dried, breed-specific formulas</li>
  <li><strong>Cat food</strong> — pâté, shredded, air-dried, indoor and weight-control formulas</li>
  <li><strong>Small pet supplies</strong> — rabbit, guinea pig, hamster, bird food and bedding</li>
  <li><strong>Fish &amp; aquarium supplies</strong></li>
...
<ol>
  ...
  <li>Shipping is <strong>$6 for orders under $49</strong>, <strong>FREE for orders $49 and over</strong></li>
  <li>Add building-specific delivery instructions at checkout</li>
  <li>Your order ships to your Bronx address</li>
</ol>
...
<div itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    <h3 itemprop="name">Do I need a membership to order?</h3>
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">No membership or subscription required. Shop and order at any time — a free account just makes reordering faster for next time.</p>
    </div>
  </div>
...
<p>Give your Bronx pet the nutrition they deserve. Shop at <a href="https://www.petshiwu.com">petshiwu.com</a> and get your order delivered fast.</p>`
  },
  {
...
<ul>
  ...
  <li><strong>Bay Ridge area ferry commuters</strong></li>
  <li><strong>Willowbrook &amp; Travis &amp; Heartland Village</strong></li>
  <li><strong>Port Richmond &amp; Mariners Harbor &amp; Howland Hook</strong></li>
</ul>

<h2>What We Deliver</h2>
<ul>
  <li><strong>Dog food</strong> — dry kibble, wet food, raw, freeze-dried, breed-specific</li>
  <li><strong>Cat food</strong> — pâté, shredded, grain-free, indoor formulas</li>
  <li><strong>Small pet supplies</strong> — rabbits, guinea pigs, birds, hamsters</li>
  <li><strong>Fish &amp; aquarium supplies</strong></li>
  <li><strong>Treats, litter, health &amp; wellness products</strong></li>
</ul>
...
<ol>
  ...
  <li>Enter delivery instructions for your home</li>
  <li>Order ships to your Staten Island address</li>
</ol>
...
<div itemscope itemtype="https://schema.org/FAQPage">
  ...
  <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    <h3 itemprop="name">Can I order pet food online and have it delivered to my Staten Island home?</h3>
    <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
      <p itemprop="text">Absolutely. Visit petshiwu.com, choose from 10,000+ products, and we ship directly to your Staten Island address. No ferry trip needed.</p>
    </div>
  </div>
...
async function run() {
  ...
  for (const hub of hubs) {
    const existing = await Blog.findOne({ slug: hub.slug });
    if (existing) {
    ...
    console.log(`✅ Created: ${hub.slug} (${blog._id})`);
  }
