  ...
  const productSchema: Record<string, unknown> = {
    ...
    offers: {
      ...
      shippingDetails: {
        ...
        shippingDestination: { '@type': 'DefinedRegion', addressCountry: 'US', addressRegion: 'NY' },
        deliveryTime: {
...
const buildNeighborhoodHtml = (
  ...
  const CATEGORY_LABELS: Record<string, { label: string; petLabel: string }> = {
    ...
    'bird-supplies-delivery': { label: 'Bird Food & Supplies Delivery', petLabel: 'bird food and supplies' },
    'puppy-food-delivery': { label: 'Puppy Food Delivery', petLabel: 'puppy food' },
    'senior-dog-food-delivery': { label: 'Senior Dog Food Delivery', petLabel: 'senior dog food' },
    'wet-dog-food-delivery': { label: 'Wet Dog Food Delivery', petLabel: 'wet dog food' },
    'dry-dog-food-delivery': { label: 'Dry Dog Food Delivery', petLabel: 'dry dog food' },
    'grain-free-dog-food-delivery': { label: 'Grain-Free Dog Food Delivery', petLabel: 'grain-free dog food' },
    'raw-dog-food-delivery': { label: 'Raw Dog Food Delivery', petLabel: 'raw dog food' },
    'dog-toys-delivery': { label: 'Dog Toys Delivery', petLabel: 'dog toys' },
    'dog-beds-delivery': { label: 'Dog Beds Delivery', petLabel: 'dog beds' },
    'dog-crates-delivery': { label: 'Dog Crates Delivery', petLabel: 'dog crates' },
    'dog-grooming-delivery': { label: 'Dog Grooming Delivery', petLabel: 'dog grooming supplies' },
    'kitten-food-delivery': { label: 'Kitten Food Delivery', petLabel: 'kitten food' },
    'senior-cat-food-delivery': { label: 'Senior Cat Food Delivery', petLabel: 'senior cat food' },
    'wet-cat-food-delivery': { label: 'Wet Cat Food Delivery', petLabel: 'wet cat food' },
    'cat-litter-boxes-delivery': { label: 'Cat Litter Boxes Delivery', petLabel: 'cat litter boxes' },
    'cat-scratcher-delivery': { label: 'Cat Scratcher Delivery', petLabel: 'cat scratchers' },
    'cat-toys-delivery': { label: 'Cat Toys Delivery', petLabel: 'cat toys' },
    'cat-beds-delivery': { label: 'Cat Beds Delivery', petLabel: 'cat beds' },
    'cat-grooming-delivery': { label: 'Cat Grooming Delivery', petLabel: 'cat grooming supplies' },
    'fish-supplies-delivery': { label: 'Fish Supplies Delivery', petLabel: 'fish supplies' },
    'reptile-supplies-delivery': { label: 'Reptile Supplies Delivery', petLabel: 'reptile supplies' },
    'vet-diet-delivery': { label: 'Vet-Authorized Diet Delivery', petLabel: 'vet-authorized diets' },
    'pet-medication-delivery': { label: 'Pet Medication Delivery', petLabel: 'pet medication' },
  };
