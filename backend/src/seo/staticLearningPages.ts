...
export const STATIC_LEARNING_PAGES: Record<string, StaticLearningPage> = {
  'best-dog-food-sensitive-stomach': {
    ...
    html: `
      ...
      <p>Shop sensitive-stomach formulas at Petshiwu with NYC same-day delivery in the five boroughs. See also our <a href="https://www.petshiwu.com/best-dog-food-sensitive-stomach-diarrhea">sensitive stomach shopping guide</a>.</p>
    `,
  },
